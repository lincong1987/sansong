                                ...
                                <div class="modal-left-menu">
                                    <div class="modal-left-menu-title">
                                        ...
                                        <ul class="modal-left-menu-content">
                                            <li><a href="<?php echo WEB_HOST; ?>php/biz/hr/index.php" target="_self" class="hover">人才战略</a></li>
                                            <li><a href="<?php echo WEB_HOST; ?>php/biz/hr/offer.php" target="_self">职位空缺</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
                            <td class="modal-left-right">
                                ...
                                <div class="modal-hr">
                                    ...
                                    <div class="modal-hr-content">
                                        <img style="float: right;" src="../../../images/hr/hr_content_1.png" />
