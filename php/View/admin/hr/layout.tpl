        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#viewGrid").grid({
                    ...
                    url: '${$smarty.const.WEB_HOST}php/Action/admin/hr/hrAction.php',
                    root: "rows",
                    setInitWidths: "40,40,150,100,120,120,70,120",
                    setColAlign: "left, center, left, left,left, left,center,center, center",
                    setHeader: "<ul style='text-align:left; padding-left:3px'><input type='checkbox' onclick='doSwitchAllChecked();' id='delAll'><ul>,序号,职位名称,学历要求,职位描述,主要福利,是否显示,更新时间",
                    columns: ["id", "_rownum", "title", "education", "description", "welfare", "display","time"],
                    render: {
                        id: function(val, row) {
                            return "<input value='" + val + "' class='chb gridChk' type='checkbox' />";
                        },
                        title: function(val, row) {
                            return "<a href='${$smarty.const.WEB_HOST}php/Action/client/hr/hrAction.php?ac=career&id=" + row.id + "' target='_blank'>" + val + "<a>";
                        },
                        description: function(val) {
                            return val.replace(/<\/?[^>]*>/g, '');
                        },
                        welfare: function(val) {
                            return val.replace(/<\/?[^>]*>/g, '');
                        },
                    ...
                    pager: {
                        setParam: function() {
                            ...
                            this.param["education"] = $.trim($("#education").val());
                            this.param["description"] = $.trim($("#description").val());
                            this.param["welfare"] = $.trim($("#welfare").val());
            ...
            function doAddRow() {
                ...
                var url = "${$smarty.const.WEB_HOST}php/Action/admin/hr/hrAction.php?" + $.param({
                    ac: "edit",
                    _id: _id
                });
            ...
            <div class="listBox2_new thBg">
                <form id="searchForm" onsubmit="return false;">
                    <div class="searchbg">
                        <table>
                            <tr>
                                <td width="80" class="texR">职位名称：</td>
                                <td width="180">
                                    <input id="title" type="text" class="ie6Input" style="width:200px;"/>
                                </td>
                                <td width="80" class="texR">要求学历：</td>
                                <td width="180">
                                    <input id="education" type="text" class="ie6Input" style="width:200px;"/>
                                </td>
                            ...
                            <tr>
                                <td width="80" class="texR">职位描述：</td>
                                <td width="180">
                                    <input id="description" type="text" class="ie6Input" style="width:200px;"/>
                                </td>
                                <td width="80" class="texR">主要福利：</td>
                                <td colspan="3">
                                    <input id="welfare" type="text" class="ie6Input" style="width:200px;"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div style="text-align:center; padding:5px 0 5px;">
                            ...
                            <input value="" class="searchBot2" id="doResetSrhForm" type="reset" />
                        </div>
                    </div>
                </form>
            </div>
