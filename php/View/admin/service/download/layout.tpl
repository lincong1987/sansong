        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#viewGrid").grid({
                    ...
                    url: '${$smarty.const.WEB_HOST}php/Action/admin/service/downloadAction.php',
                    root: "rows",
                    setInitWidths: "40,40,300,100,120,120",
                    setColAlign: "left, center, left, center,center, center,left,left, center",
                    setHeader: "<ul style='text-align:left; padding-left:3px'><input type='checkbox' onclick='doSwitchAllChecked();' id='delAll'><ul>,序号,名称,是否显示,地址,发布时间",
                    columns: ["id", "_rownum", "name", "display", "path", "time"],
                    render: {
                        id: function(val, row) {
                            return "<input value='" + val + "' class='chb gridChk' type='checkbox' />";
                        },
                        path: function(val) {
                            return "<a href='${$smarty.const.WEB_HOST}${$smarty.const.Q_DOWNLOAD_PATH}" + val + "' target='_blank'>" + val + "<a>";
                        },
            ...
            function doAddRow() {
                ...
                var url = "${$smarty.const.WEB_HOST}php/Action/admin/service/downloadAction.php?" + $.param({
                    ac: "edit",
                    _id: _id
                });
            ...
            <div class="listBox2_new thBg">
                <form id="searchForm" onsubmit="return false;">
                    <div class="searchbg">
                        <table>
                            <tr>
                                <td width="80" class="texR">资料名称：</td>
                                <td width="180">
