        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#viewGrid").grid({
                    ...
                    url: '${$smarty.const.WEB_HOST}php/Action/admin/case/caseAction.php',
                    root: "rows",
                    setInitWidths: "40,40,200,250,70,70,120",
                    setColAlign: "left, center, left, center, center, center, center, center, center",
                    setHeader: "<ul style='text-align:left; padding-left:3px'><input type='checkbox' onclick='doSwitchAllChecked();' id='delAll'><ul>,序号,案例名称,案例描述,排序,是否显示,更新时间",
                    columns: ["id", "_rownum", "name", "description", "sort", "display","time"],
                    render: {
                        id: function(val, row) {
            ...
            function doAddRow() {
                ...
                var url = "${$smarty.const.WEB_HOST}php/Action/admin/case/caseAction.php?" + $.param({
                    ac: "edit",
                    _id: _id
                });
            ...
            <div class="listBox2_new thBg">
                <form id="searchForm" onsubmit="return false;">
                    <div class="searchbg">
                        <table>
                            <tr>
                                <td width="80" class="texR">酒店名称：</td>
                                <td width="180">
                                    <input id="name" type="text" class="ie6Input" style="width:200px;"/>
                                </td>
                                <td width="80" class="texR">说明：</td>
                                <td width="180">
