            ...
            <div class="modal-main clearfix">
                <div class="container">
                    <div class="modal-service-project-banner">
                        <img src="${$smarty.const.WEB_HOST}images/service/download_banner.png" />
                    </div>
                    <!-- 左右结构 -->
                    <table class="modal-l-r">
                        ...
                        <tr>
                                ...
                                <div class="modal-left-menu">
                                    <div class="modal-left-menu-title">
                                        ...
                                        <ul class="modal-left-menu-content">
                                            <li><a href="${$smarty.const.WEB_HOST}php/Action/client/service/serviceAction.php?ac=index" target="_self">工程实施</a></li>
                                            <li><a href="${$smarty.const.WEB_HOST}php/Action/client/service/serviceAction.php?ac=aftersale" target="_self">售后服务</a></li>
                                            <li><a href="${$smarty.const.WEB_HOST}php/Action/client/service/serviceAction.php?ac=download" target="_self" class="hover">资料下载</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
                            <td class="modal-left-right">
                                <!-- 工程实施 -->
                                <div class="modal-service-download">
                                    <div class="modal-service-download-title"></div>
                                    <div class="modal-service-download-content">
                                        <div class="modal-service-download-title-bar">
                                            <ul>
                                                <li><a>资料名称</a><span>更新时间</span></li>
                                            </ul>
                                        </div>
                                        <div class="modal-service-download-list">
                                            <ul>
                                                ${foreach from=$downloadList item=download}
                                                <li><a target="_blank" title="点击下载" href="${$smarty.const.WEB_HOST}${$smarty.const.Q_DOWNLOAD_PATH}${$download.path}">${$download.name}</a><span>${$download.time|date_format:'%Y-%m-%d'}</span></li>
                                                ${/foreach}
                                            </ul>
                                        </div>
                                        <div id="pager"></div>
