                                ...
                                <div class="modal-left-menu">
                                    <div class="modal-left-menu-title">
                                        ...
                                        <ul class="modal-left-menu-content">
                                            ...
                                            <li><a href="${$smarty.const.WEB_HOST}php/Action/client/service/serviceAction.php?ac=aftersale" target="_self" class="hover">售后服务</a></li>
                            ...
                            <td class="modal-left-right">
                                ...
                                <div class="modal-service-aftersale">
                                    ...
                                    <div class="modal-service-aftersale-content">
                                        <img style="float: right;" src="${$smarty.const.WEB_HOST}images/service/service_aftersale_content_1.png" />
                                        ...
                                        <img style="float: left;" src="${$smarty.const.WEB_HOST}images/service/service_aftersale_content_2.png" />
                                        ...
                                        <img src="${$smarty.const.WEB_HOST}images/service/service_aftersale_content_3.png" />
                                    </div>
                                </div>
                            </td>
                        </tr>
