                                ...
                                <div class="modal-left-menu">
                                    <div class="modal-left-menu-title">
                                        ...
                                        <ul class="modal-left-menu-content">
                                            <li><a href="${$smarty.const.WEB_HOST}php/Action/client/about/aboutAction.php?ac=introduction" target="_self" class="hover">西软简介</a></li>
                            ...
                            <td class="modal-left-right" valign="top">
                                ...
                                <div class="modal-about-introduction">
                                    ...
                                    <div class="modal-about-introduction-content">
                                        <img style="float: right;" src="${$smarty.const.WEB_HOST}images/about/introduction_content_pic_01.png" />
