 ...
 *     QQ: 159257119
 *  Phone: 15925711961
 *  This File Created On 2013-9-11 16:26:08.
 *  Document   : newjavascript.js
 *  Encoding   : UTF-8
 *  $Id$
 */
...
$(function() {
        ...
        if (b.attr("debug") == "true" || b.attr("debug") == true) {
            if (broswerFlag == "IE6" || broswerFlag == "IE7") {
                if (b.attr("href") == "") {
                    ...
                    $.ajax({url: prePath + "libs/skins/" + themeColor + "/style.css", error: function() {
                            ...
                            $.ajax({url: prePath + skinName + "style.css", error: function() {
                                    if ($("body").attr("leftFrame") == "true" || $("body").attr("leftFrame") == true) {
    ...
    if (fontSize != 12) {
        ...
        if ($("table:[class=tableStyle]").length > 0) {
            $("table:[class=tableStyle]").css({fontSize: fontSize + "px"})
        }
        if ($("pre").length > 0) {
            $("pre").css({fontSize: fontSize + "px"})
        }
    }
    if (autoRender == true) {
        $("div").each(function() {
...
function changeFont(a) {
    $("body").css({fontSize: a + "px"});
    if ($("table:[class=tableStyle]").length > 0) {
        $("table:[class=tableStyle]").css({fontSize: a + "px"})
    }
    if ($("pre").length > 0) {
        $("pre").css({fontSize: a + "px"})
    }
    if ($("iframe").length > 0) {
...
(function(a) {
    ...
    a.fn.box1Render = function() {
        var b;
        if (a(this).find(".boxContent").length > 0) {
        } else {
            b = a(this).html();
            a(this).empty();
    ...
    a.fn.box1Build = function() {
        ...
        if (a(this).attr("overflow") == "true" || a(this).attr("overflow") == true) {
            a(this).find(".boxContent").css({overflow: "auto"})
        } else {
            if (a(this).attr("overflow") == "false" || a(this).attr("overflow") == false) {
                a(this).find(".boxContent").css({overflow: "hidden"})
            } else {
                a(this).find(".boxContent").css({overflow: "visible"})
            }
        }
    ...
    a.fn.box2Build = function() {
        ...
        if (f.attr("iconClass") != null) {
            ...
            o.css({backgroundPosition: "0 50%"})
        } else {
            if (f.attr("iconSrc") != null) {
                o.css({backgroundImage: "url(" + a(this).attr("iconSrc") + ")", backgroundRepeat: "no-repeat", backgroundPosition: "0 50%", display: "block", paddingLeft: "18px"})
            }
        }
        ...
        if (f.attr("panelSubTitleColor") != null) {
            a(this).find(".boxSubTitle").css({color: f.attr("panelSubTitleColor")})
        }
        if (a(this).attr("panelWidth") != null) {
    ...
    a.fn.textinputRender = function() {
        ...
        if (a(this).attr("maxNum") != null) {
            a(this).maxlength({maxCharacters: parseInt(a(this).attr("maxNum"))})
        }
    ...
    a.fn.fileRender = function() {
        ...
        f.width(d);
        e.width(d);
        a(this).css({position: "absolute", "z-index": 20, "font-size": "118px", opacity: "0", left: "0px", top: "0px"});
    ...
    a.fn.buttonInputRender = function() {
        ...
        if (a(this).attr("useMinWidth") == "false" || a(this).attr("useMinWidth") == false) {
        } else {
            if (c < 5) {
                a(this).width(60)
            }
    ...
    a.fn.buttonRender = function() {
        ...
        if (broswerFlag == "Firefox" || broswerFlag == "Opera" || broswerFlag == "Safari") {
            a(this).filter(":has(span)").css({paddingLeft: "5px", width: d + 8 + "px"})
        } else {
            a(this).filter(":has(span)").css({paddingLeft: "5px", width: d + "px"})
        }
        if (c < 5) {
            a(this).width(66)
        }
        a(this).filter(":has(span)").find("span").css({cursor: "default"});
        a(this).hover(function() {
            a(this).addClass("button_hover")
        }, function() {
            a(this).removeClass("button_hover")
    ...
    a.fn.dateRender = function() {
        ...
        a(this).focus(function() {
            try {
                WdatePicker({skin: themeColor, isShowClear: true, dateFmt: c, doubleCalendar: b, onpicked: function(e) {
                        a(this).blur()
                    }})
            } catch (f) {
    ...
    a.fn.singleNavRender = function() {
        ...
        b.find(">div span").each(function() {
            ...
            a(this).hover(function() {
                a(this).animate({paddingLeft: "40px"}, "fast")
            }, function() {
                a(this).animate({paddingLeft: "20px"})
            })
        })
    };
    a.fn.singleNavMinRender = function() {
        ...
        b.find(">div span").each(function() {
            ...
            a(this).hover(function() {
                a(this).animate({paddingLeft: "30px"}, "fast")
            }, function() {
                a(this).animate({paddingLeft: "10px"})
            })
        })
    };
        ...
        return this.each(function() {
            if (a(this).attr("mode") == "list") {
                if (a(this).attr("thTrueWidth") == "true" || a(this).attr("thTrueWidth") == true) {
                    a("#scrollContent").css({overflowX: "auto"});
                    var b = 0;
                ...
                if (a(this).attr("fixedCellHeight") == "true" || a(this).attr("fixedCellHeight") == true) {
                } else {
            ...
            if (a(this).attr("formMode") == "line") {
                ...
                a(this).attr("useClick", "false");
                a(this).find("th").css({fontWeight: "bold", "text-align": "center"});
                ...
                a(this).find("td").css({paddingTop: "3px", paddingBottom: "3px"})
            } else {
                if (a(this).attr("formMode") == "transparent") {
                    ...
                    a(this).attr("useClick", "false");
                    a(this).find("th").css({fontWeight: "bold", "text-align": "center"});
                    a(this).css({border: "none", backgroundColor: "transparent"});
                    a(this).find("tr").css({border: "none", backgroundColor: "transparent"});
                    a(this).find("tr").find("td:even").css("text-align", "right");
                    if (a(this).attr("footer") != null) {
                        if (a(this).attr("footer") == "left") {
                            a(this).find("tr:last").find("td").css("text-align", "left")
                    ...
                    a(this).find("td").css({paddingTop: "3px", paddingBottom: "3px", border: "none"})
                } else {
                    if (a(this).attr("formMode") == "view") {
                        ...
                        if (a(this).attr("footer") != null) {
                            if (a(this).attr("footer") == "left") {
                                a(this).find("tr:last").find("td").css({textAlign: "left", backgroundColor: "#ffffff"})
                            } else {
                                if (a(this).attr("footer") == "right") {
                                    a(this).find("tr:last").find("td").css({textAlign: "right", backgroundColor: "#ffffff"})
                                } else {
                                    if (a(this).attr("footer") == "center") {
                                        a(this).find("tr:last").find("td").css({textAlign: "center", backgroundColor: "#ffffff"})
                                    } else {
                                        if (a(this).attr("footer") == "normal") {
                                            a(this).find("tr:last").find("td:even").css({textAlign: "right", backgroundColor: "#ffffff"})
                                        }
                                    }
                                }
                            }
                        ...
                        a(this).find("td").css({paddingTop: "6px", paddingBottom: "6px"})
                    }
                }
            }
...
jQuery.fn.extend({selectRender: function() {
        return this.each(function() {
...
jQuery.SelectBox = function(K) {
    ...
    function D() {
        ...
        b.css({overflowY: "auto", overflowX: "hidden"});
        if (A != 1) {
            b.width((s + 6) * A)
        } else {
            if (!N.attr("boxWidth")) {
    ...
    function P(T) {
        if ($(T.target).attr("id") == i || $(T.target).attr("id") == z || $(T.target).parent().attr("class") == "selectbox-wrapper" || $(T.target).attr("class") == "selectbox-wrapper" || $(T.target).parents(".selectbox-wrapper").length > 0) {
        } else {
            a()
        }
    }
        ...
        if (T == true) {
            ...
            if (W) {
                ...
                if (V) {
                    ...
                    if (ab) {
                        $.ajax({url: N.attr("url"), dataType: "json", data: aa, error: function() {
...
(function(c) {
    ...
    c.fn.TextAreaResizer = function() {
        return this.each(function() {
            ...
            c(this).wrap('<div class="resizable-textarea"><span></span></div>').parent().append(c('<div class="grippie"></div>').bind("mousedown", {el: this}, b)).wrap('<table cellspacing="0" cellpadding="0" style="border-style:none;"><tr><td class="ali01" style="border-style:none;padding:0;margin:0;"></td></tr></table>');
    ...
    function l(m) {
        return{x: m.clientX + document.documentElement.scrollLeft, y: m.clientY + document.documentElement.scrollTop}
    }}
)(jQuery);
(function(a) {
...
if (jQuery) {
    (function(a) {
        ...
        a.extend({cursorMessage: function(c, b) {
                if (b == undefined) {
                    b = {}
                }
                ...
                a("#cursorMessageDiv").css({top: (a.cursorMessageData.mouseY + a.cursorMessageData.options.offsetY) + "px", left: (a.cursorMessageData.mouseX + a.cursorMessageData.options.offsetX)})
            }})
    })(jQuery)
}
...
(function(d) {
    ...
    function b(i) {
        if (!i.next().hasClass("text_clear_button")) {
            ...
            var f = i.next();
            var g = f.outerHeight(), m = f.outerHeight();
...
(function(a) {
    a.fn.maxlength = function(b) {
        var c = jQuery.extend({events: [], maxCharacters: 10, status: true, statusClass: "maxNum", statusText: "剩余字数", notificationClass: "notification", showAlert: false, alertText: "输入字符超出限制.", slider: true}, b);
...
(function(b) {
    var a = new function() {
        ...
        this.getStrength = function(i, e) {
            ...
            var g = this.countRegexp(i, /\d/g), l = this.countRegexp(i, /[a-z]/g), f = this.countRegexp(i, /[A-Z]/g), d = c - g - l - f;
            if (g == c || l == c || f == c || d == c) {
                return 1
            }
            var h = 0;
    ...
    b.fn.password_strength = function(c) {
        var d = b.extend({container: null, minLength: 6, texts: {1: "非常弱", 2: "弱密码", 3: "强度一般", 4: "强密码", 5: "非常强"}}, c);
        return this.each(function() {
            if (d.container) {
                var e = b(d.container)
            } else {
